package com.mcp.tools.pro.code.generator.util;
...
public class CodeUtils {
    ...
    private static final String REPO_SUFFIX = "Dao       ";
    ...
    public static void renameServicesToRepositories(String basePath, Boolean isImpl) {
        ...
        for (String fileName : oldFileNames) {
            ...
            if (isImpl) {
                ...
                FilePlusUtils.modifyFileContent(oldFilePath, "       ", "");
                FilePlusUtils.appendContentToFile(oldFilePath, "}");
            }

            // 新的文件名路径
            String newFilePath = FilePlusUtils.combinePath(basePath, newFileName);
            newFilePath = newFilePath.replace("       .java", ".java");
            newFilePath = newFilePath.replaceAll(REPO_IMPL_SUFFIX, DAO_IMPL_SUFFIX);

            FilePlusUtils.moveFilePath(oldFilePath, newFilePath);

            FilePlusUtils.replaceFileStr(newFilePath, "Repository", "Dao");
            FilePlusUtils.replaceFileStr(newFilePath, "@Dao", "@Repository");
        }
    }
