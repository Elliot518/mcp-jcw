package com.mcp.infrastructure.common.domain.util;
 ...
 * @author: KG
 * @description:
 * @date: Created in 5:21 下午 2020/11/3
 * @modified by:
 */
...
public class IdCardUtils {
     ...
     */
    public static String verify(String idStr) {
    ...
    public static void main(String[] args) {
        System.out.println(verify("310113197913141431"));
    }
}
